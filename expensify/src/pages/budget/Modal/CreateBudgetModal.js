...
import { CUSTOM, defaultDateFormat, expenseCategories, periodCategories } from '../../../utils/constant';
...
const CreateBudgetModal = ({ open, onClose }) => {
            ...
            <div className='flex flex-col gap-3'>
                <Formik
                    initialValues={{
                        ...
                        category: [],
                        amount: '',
                        startDate: moment().format(defaultDateFormat), endDate: ''
                    }}
